...
module.exports = function(config) {
  ...
  var getPurchasedDatasets = function(user, cb) {
    var URL_BUSINESS_FRAMEWORK =
    'https://demo-mwc.conwet.com/DSProductInventory/api/productInventory/v2/product?productCharacteristic.value=CKAN%20Dataset&fields=productCharacteristic,relatedParty';
    var TOKEN = config.magicTokenPayment;
    
    Request({
      url: URL_BUSINESS_FRAMEWORK,
      headers: {
    ...
    cb(null, [{
      ...
      {
      'entityType': 'Garage',
      'endPoint':   'https://api.ost.pt/ngsi10/contextEntityTypes/pois/?category=9&municipality=806&key=hackacityporto2015_browser'
      }]);
      */
  }
